      ...
      <div class="collapse navbar-collapse" id="navbarsExample02">
        ...
        <form action="index.php" method="post" autocomplete="off">
          <div class="user-container navbar-nav me-auto">
            ...
            <input type="submit" name="login" class="btn btn-danger btn-sm" value="OFF" />
          </div>
        </form>
      </div>
    </div>
      ...
      <div class="table-menu">
        ...
        <div class="">
          <div class="input-group input-group-sm mb-3 rounded-pill">
              <input class="form-control" type="search" placeholder="Search" aria-label="Search" aria-label="Small">
